...
class Replica(object):
    ...
    def replicaInit(self, replicas, replica_cores, mdExecutable, exchangeMethod):     # "Cycle" = 1 MD stage plus the subsequent exchange computation

        """ 
        Initial cycle consists of:
        1) Create tarball of MD input data 
        2) Transfer the tarball to pilot sandbox
        3) Untar the tarball on local or shared file system. 
        5) Run first MD Cycle
        """    
